...
export declare const getDateWithoutYearFromTimezoneAgnosticDate: (date: number) => number;
export declare const getDateWithoutDayFromTimezoneAgnosticDate: (date: number) => number;
export declare const getFirstDayOfMonth: (date: number) => number;
...
export declare const getLastDayOfMonth: (baseDate: number) => number;
...
export declare const getLastNTimeZoneAgnosticDays: (baseDate: number, numberOfDays: number) => number[];
export declare const getFollowingNTimeZoneAgnosticDays: (baseDate: number, numberOfDays: number) => number[];
export declare const getTimeZoneAgnosticDatesBetweenDates: (smallerDate: number, higherDate: number) => number[];
export declare const getTimeZoneAgnosticDaysDifference: (smallerDate: number, higherDate: number) => number;
export declare const getCurrentDayOrDaysTillPreviousMonday: (baseDate: number) => number[];
export declare const getCurrentDayOrDaysTillNextSunday: (baseDate: number) => number[];
