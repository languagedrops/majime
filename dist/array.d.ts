...
export declare const randomElements: <T>(fromArray: T[], count: number, safeExecution?: boolean) => T[];
...
export declare const sortedByProperty: <T>(sourceArray: T[], compareFunction: (element: T) => number | string | Date, reverse?: boolean) => T[];
...
export declare const takeWhile: <T>(inputArray: T[], filterFunction: (element: T, index: number) => boolean, reverse?: boolean) => T[];
export declare const skipWhile: <T>(inputArray: T[], filterFunction: (element: T, index: number) => boolean, reverse?: boolean) => T[];
